 ...
 * Provides realistic sample data for tracked quantum computing companies.
 */
...
const companies: CompanyResponse[] = [
  ...
  { id: 12, name: "Defiance Quantum ETF", slug: "defiance-quantum-etf", sector: "etf", ticker: "QTUM", description: "The Defiance Quantum ETF tracks companies involved in quantum computing, machine learning, and other transformative technologies.", is_etf: true, website: null, logo_url: null },
];
...
const scores: Record<string, ScoreResponse> = {
  ...
  "defiance-quantum-etf": { total_score: 41.8, stock_momentum: 12.8, patent_velocity: 0, qubit_progress: 0, funding_strength: 0, news_sentiment: 10.8, score_date: MOCK_DATE, rank: 12, rank_change: 0 },
};
...
function generateStockHistory(slug: string, days: number): StockHistoryResponse {
  const basePrice: Record<string, number> = {
    ...
    intel: 28.7, "honeywell-quantinuum": 215.8,
    "defiance-quantum-etf": 72.4,
  };
