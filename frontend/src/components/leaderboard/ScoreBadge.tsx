...
function getScoreColor(score: number): string {
  if (score >= 80) return "bg-green-100 text-green-800 dark:bg-green-900/60 dark:text-green-300";
  if (score >= 60)
...
export function ScoreBadge({ score }: ScoreBadgeProps) {
  return (
    <div className="flex items-center gap-2">
      ...
      <div className="hidden h-2 w-16 overflow-hidden rounded-full bg-gray-200 sm:block dark:bg-slate-700">
        <div
